...
OQPSK_2530 = np.zeros((OQPSK_Symbol_Length, Despreading_Number)) + np.zeros(
    (OQPSK_Symbol_Length, Despreading_Number)) * 1j
    ...
    for m in range(0, Despreading_Number):
        ...
        if (Temp_2 == 1):
            for i in range(0, OQPSK_Sample_per_Symbol):
                OQPSK_2530[m * OQPSK_Sample_per_Symbol + i, n] = OQPSK_2530[m * OQPSK_Sample_per_Symbol + i, n] + \
                                                                 Sine_Symbol[i, 0]
        else:
            for i in range(0, OQPSK_Sample_per_Symbol):
                OQPSK_2530[m * OQPSK_Sample_per_Symbol + i, n] = OQPSK_2530[m * OQPSK_Sample_per_Symbol + i, n] + \
                                                                 Sine_Symbol[i + OQPSK_Sample_per_Symbol, 0]

        Temp_1 = data_map[n][2 * m + 1]
        Temp_2 = int(Temp_1)
        if (Temp_2 == 1):
            for i in range(0, OQPSK_Sample_per_Symbol):
                OQPSK_2530[int(OQPSK_Sample_per_Symbol / 2) + m * OQPSK_Sample_per_Symbol + i, n] = OQPSK_2530[
                                                                                                        int(OQPSK_Sample_per_Symbol / 2) + m * OQPSK_Sample_per_Symbol + i, n] + 1j * \
                                                                                                    Sine_Symbol[i, 0]
        else:
            for i in range(0, OQPSK_Sample_per_Symbol):
                OQPSK_2530[int(OQPSK_Sample_per_Symbol / 2) + m * OQPSK_Sample_per_Symbol + i, n] = OQPSK_2530[
                                                                                                        int(OQPSK_Sample_per_Symbol / 2) + m * OQPSK_Sample_per_Symbol + i, n] + 1j * \
                                                                                                    Sine_Symbol[
                                                                                                        i + OQPSK_Sample_per_Symbol, 0]

OQPSK_2530_Detection = np.conj(OQPSK_2530)

# Generate synchronization samples

Synchronization_Symbol_Length = len(Synchronization_Code) * OQPSK_Sample_per_Symbol * Despreading_Number + int(
    OQPSK_Sample_per_Symbol / 2)
Synchronization_Symbol_Sample = np.zeros((Synchronization_Symbol_Length, 1)) + 1j * np.zeros(
    (Synchronization_Symbol_Length, 1))

for n in range(0, len(Synchronization_Code)):
    Synchronization_Symbol_Sample[
    n * OQPSK_Sample_per_Symbol * Despreading_Number:(n + 1) * OQPSK_Sample_per_Symbol * Despreading_Number, 0] \
        = Synchronization_Symbol_Sample[
          n * OQPSK_Sample_per_Symbol * Despreading_Number:(n + 1) * OQPSK_Sample_per_Symbol * Despreading_Number, 0] \
    ...
    Synchronization_Symbol_Sample[n * OQPSK_Sample_per_Symbol * Despreading_Number + int(OQPSK_Sample_per_Symbol / 2): \
                                  (n + 1) * OQPSK_Sample_per_Symbol * Despreading_Number + int(
                                      OQPSK_Sample_per_Symbol / 2), 0] = \
        Synchronization_Symbol_Sample[
        n * OQPSK_Sample_per_Symbol * Despreading_Number + int(OQPSK_Sample_per_Symbol / 2): \
        ...
        1j * np.imag(OQPSK_2530[int(OQPSK_Sample_per_Symbol / 2):OQPSK_Sample_per_Symbol * Despreading_Number \
                                                                 + int(OQPSK_Sample_per_Symbol / 2),
                     Synchronization_Code[n]])
...
for n in range(0, len(test_Code)):
    ...
    test_Symbol_Sample[n * OQPSK_Sample_per_Symbol * Despreading_Number + int(OQPSK_Sample_per_Symbol / 2): \
                       (n + 1) * OQPSK_Sample_per_Symbol * Despreading_Number + int(OQPSK_Sample_per_Symbol / 2), 0] = \
        test_Symbol_Sample[n * OQPSK_Sample_per_Symbol * Despreading_Number + int(OQPSK_Sample_per_Symbol / 2): \
                           (n + 1) * OQPSK_Sample_per_Symbol * Despreading_Number + int(OQPSK_Sample_per_Symbol / 2),
        0] + \
        1j * np.imag(OQPSK_2530[int(OQPSK_Sample_per_Symbol / 2):OQPSK_Sample_per_Symbol * Despreading_Number \
